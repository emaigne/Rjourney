...
Mais `data.table` fournit la fonction `setDF` moins gourmand en ressources (utile pour les gros datasets) puisqu'il n'oblige pas à copier l'objet en mémoire, contrairement au traditionnel `<-`.
